...
instance Print Program where
  prt i e = case e of
    Prog stm -> prPrec i 0 (concatD [prt 0 stm])
...
instance Print Stm where
  prt i e = case e of
    ...
    SFor stm1 exp stm2 stm3 -> prPrec i 0 (concatD [doc (showString "for"), doc (showString "("), prt 0 stm1, prt 0 exp, doc (showString ";"), prt 0 stm2, doc (showString ")"), prt 0 stm3])
    SIf exp stm -> prPrec i 0 (concatD [doc (showString "if"), doc (showString "("), prt 0 exp, doc (showString ")"), doc (showString "then"), prt 0 stm])
    SIfE exp stm1 stm2 -> prPrec i 0 (concatD [doc (showString "if"), doc (showString "("), prt 0 exp, doc (showString ")"), doc (showString "then"), prt 0 stm1, doc (showString "else"), prt 0 stm2])
  prtList _ [] = (concatD [])
